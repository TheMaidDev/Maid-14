trade-shuttle-console-menu-title = Trade shuttle console
trade-shuttle-console-location-trade = Trade Station
trade-shuttle-console-location-station = Station
trade-shuttle-console-controlled-shuttle-self = This Shuttle
trade-shuttle-console-controlled-shuttle-other = {$shuttleName}
trade-shuttle-console-status-ftl-progress = {$ftlStatus} to {$destination}
trade-shuttle-console-status-idle = At {$location}
trade-shuttle-console-button-call = Call to Station
